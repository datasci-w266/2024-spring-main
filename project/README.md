...
Additionally, we've put some of the top projects from previous semesters in [a drive folder](https://drive.google.com/drive/WhenClassStarts).  The folder and its contents are available for viewing to anyone with a berkeley.edu email address.
